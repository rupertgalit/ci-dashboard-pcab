...
<div class="row w-100">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body p-1 pt-3">
                ...
                <div class="mx-auto my-5 d-flex justify-content-center flex-column" style="width: 67.5rem; ">
                    <div class="w-75 mx-auto" style="margin-bottom:0;border:1px #666 dashed;">
                        ...
                        <div class="">
                                    ...
                                    <tr>
                                        <td colspan="2" class="pl-5">
                                            <div class="w-100 d-flex justify-content-between">
                                                <span>
                                                    Date: <label class="border-bottom border-dark text-center m-0" style="width:5rem;display:inline-block"></label>
                                                </span>
                            ...
                            <div class="w-100 mt-5">
                                <div class="container">
                                    <div class="row mt-4">
                                        <div class="col pl-5">
                                            <img style="margin-left:20%; background-position:center; margin-bottom:-15px;z-index:0;position:relative;transform:scale(1.1)" width="35%" height="35%" src="assets/images/ma'am_je.png" alt="logo" class="logo-dark" />
                                            <p style="position:relative;left:-11px;margin:0;">Prepared By: </p>
                                            <p style="margin-top: -25px;margin-left: 87px;font-size: 18px; font-family: Arial, Helvetica, sans-serif;z-index:1;position:relative;">
                                                Jeremie Soliveres </p>
                                            <p style=" margin-top: -24px; margin-left: 106px; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                        ...
                                        <div class="col pl-5">
                                            ...
                                            <p style="margin-top: -25px;margin-left: 12rem;font-size: 18px; font-family: Arial, Helvetica, sans-serif;">
                                                Peter Lingatong</p>
                                            <p style=" margin-top: -24px; margin-left: 13rem; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                Chairman & CEO</p>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            ...
            const content = () => `
        <div class="mx-auto" style="border:1px #666 dashed;[mb];width: 65rem;">
                    <div class="container justify-content-center mb-1">
                        <div class="row d-flex flex-row justify-content-center" style="transform: scale(.9);">
                            <div class="col-md-3">
                                <img height="100px" style="margin-left:-1rem;"
                                    src="assets/images/ngsi-letterhead.png" alt="logo" class="logo-dark" />
                            </div>
                            <div class="col-md-4 mt-3" style="margin-left:9rem;">
                                <p class="font-weight-bold" style="font-family: Century Gothic; font-size:16px;" ;>
                                    NET GLOBAL SOLUTIONS&nbsp;&nbsp; INC.</p>
                                <p style="margin-top: -20px;margin-bottom: -5px; font-family: Century Gothic;">Tel.
                                    No. 632 82877374</p>
            ...
            function downloadDeposit() {
                ...
                for (let i = 0; i < 10; i++) {
                    if (i % 2 == 0) {
                        // console.log(i, i != 39)
                        if (i > 0 && i != 9) toPrint += `<div class="mx-auto" style="display:block;width:100%;margin-bottom:.30in"></div>`;
                        toPrint += content()

                    } else toPrint += `<div style="display:block;width:100%;border-bottom:1px #666 dashed;margin:5rem 0;"></div>${content().replace("[mb]",`margin-bottom: 10rem`)}`; //.replace("[mb]",`margin-bottom: 4in`)

                    // if (i == 0)
                    //     toPrint += `<div class="mx-auto" style="display:block;width:100%;margin-bottom:4.2in"></div>`
                    // else
                    //     toPrint += `<div class="mx-auto" style="display:block;width:100%;margin-bottom:4in"></div>`
                    // } else toPrint += ${content()

                }
                console.log(doc.internal.pageSize)
                doc.html(`<div class="mx-auto d-flex justify-content-center flex-column border-dark p-0" style="border:1px #000 solid;margin-top:3rem;width:80rem;">${toPrint}</div>`, {
                    html2canvas: {
                        scale: .35
                    },
                    async callback(pdf) {
