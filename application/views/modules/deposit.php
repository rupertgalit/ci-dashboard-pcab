...
<div class="row w-100">
    <div class="col-md-12 grid-margin stretch-card">
        ...
        <script>
            ...
            const content = () => `
        <div class="mx-auto" style="[mb];width: 65rem;">
                                ...
                                <div class="">
                                    <div class="row" style="height:6rem;">
                                        <div class="col" style="position:relative;left:60px">
                                            <img style="margin-left: 20%;background-position:center;margin-bottom:-15px;z-index:0;transform:scale(1.1);display:block;position:relative;top:-7px;height:3rem;" width="35%" height="35%" src="assets/images/ma'am_je.png" alt="logo" class="logo-dark" />
                                        ...
                                        <div class="col" style="position:relative;left:120px;">
                                            <img style="margin-left:13rem; margin-bottom:-15px;background-position:center;margin-bottom:-15px;z-index:0;transform:scale(1);display:block;position:relative;top:-7px;height:3rem;left: -26px;" width="35%" height="35%" src="assets/images/sir_peter.png" alt="logo" class="logo-dark" />
                                            <p style="position:relative;left:5.7rem;margin:0;">Approved By: </p>
                                            <p style="margin-top:-25px;margin-left:12rem;font-size:18px;font-family:Arial,Helvetica,sans-serif;z-index:1;position:relative;">
                                                Peter Lingatong</p>
                                            <p style=" margin-top:-24px;margin-left:13rem;font-family:Arial,Helvetica,sans-serif;font-size:12px;z-index:1;position:relative;">
                                                Chairman & CEO</p>
                                        </div>
                                    </div>
                                </div>
